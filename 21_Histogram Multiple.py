...
def test_run():
    ...
    #daily_return.hist(bins=20) # bins default is 10
    daily_return['AAPL'].hist(bins=20, label='AAPL') # bins default is 10
    daily_return['SPY2'].hist(bins=20, label='SPY') # bins default is 10
